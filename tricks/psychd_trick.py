...
def psychd_trick(data):
    ...
    psychd_logo = re.compile(
        r"\s*oooo              \.o8(.*)(\r*\n)" +
        r"\s*`888             \"888(.*)(\r*\n)" +
        r"\s*oo\.ooooo\.   \.oooo\.o oooo    ooo  \.ooooo\.   888 \.oo\.    \.oooo888(.*)(\r*\n)" +
        r"\s*888' `88b d88\(  \"8  `88\.  \.8'  d88' `\"Y8  888P\"Y88b  d88' `888(.*)(\r*\n)" +
        r"\s*888   888 `\"Y88b\.    `88\.\.8\'   888        888   888  888   888(.*)(\r*\n)" +
        r"\s*888   888 o\.  \)88b    `888\'    888   \.o8  888   888  888   888(.*)(\r*\n)" +
        r"\s*888bod8P\' 8\"\"888P'     \.8'     `Y8bod8P\' o888o o888o `Y8bod88P\"(.*)(\r*\n)"+
        r"\s*888                \.o\.\.P'(.*)(\r*\n)" +
        r"\s*o888o               `Y8P\'(.*)(\r*\n)",
        re.M
    )
